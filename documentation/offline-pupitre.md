...
`PupitreRuntime` restores authentication and owns the initial synchronization, online listeners and refresh timers. Its destruction
removes listeners, clears timers and prevents later work from starting. Tests use explicit
