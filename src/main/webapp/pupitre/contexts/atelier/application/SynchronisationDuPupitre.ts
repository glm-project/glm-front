...
import { decideRejeu, operationFor } from '@/pupitre/contexts/atelier/domain/PolitiqueDeRejeu';
import { EvenementLocal, GesteLocal, PUPITRE_VIDE, PupitreLocal } from '@/pupitre/contexts/atelier/domain/PupitreLocal';
