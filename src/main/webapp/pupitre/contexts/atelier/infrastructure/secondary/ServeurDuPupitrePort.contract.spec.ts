...
import { decideRejeu, DecisionDeRejeu } from '@/pupitre/contexts/atelier/domain/PolitiqueDeRejeu';
import { GesteLocal, ReferentielDuPupitre } from '@/pupitre/contexts/atelier/domain/PupitreLocal';
