...
export const LIBELLES_SUPERVISION = {
  ...
  nc: 'NC',
  sansAffectation: 'GLM',
  sansAffectationDetails: 'GLM · Aucune activité en cours',
  sansAffectationMaintenant: 'GLM à l’instant courant',
  sansAffectationMaintenantHorsPlage: 'GLM à l’instant courant · hors plage',
