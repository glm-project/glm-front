/**
 * La forme qu'`java.time.Duration` sérialise : heures, minutes et secondes seulement, heures non bornées, et
 * `PT0S` pour une durée nulle. Les jours et les semaines sont donc refusés — le back n'en produit pas.
 */
...
/**
 * Les secondes sont tronquées — un relevé s'affiche en heures et minutes — mais elles sont lues, sans quoi
